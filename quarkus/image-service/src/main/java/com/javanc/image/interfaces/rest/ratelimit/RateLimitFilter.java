package com.javanc.image.interfaces.rest.ratelimit;
...
public class RateLimitFilter implements ContainerRequestFilter {
    ...
    public RateLimitFilter(
            ...
            @ConfigProperty(name = "quarkus.application.name", defaultValue = "image-service") String serviceName,
        ...
        this.serviceName = value(serviceName).isBlank() ? "image-service" : serviceName.trim();
