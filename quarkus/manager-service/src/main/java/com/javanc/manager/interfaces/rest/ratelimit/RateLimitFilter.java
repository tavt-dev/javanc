package com.javanc.manager.interfaces.rest.ratelimit;
...
public class RateLimitFilter implements ContainerRequestFilter {
    ...
    public RateLimitFilter(
            ...
            @ConfigProperty(name = "quarkus.application.name", defaultValue = "manager-service") String serviceName,
        ...
        this.serviceName = value(serviceName).isBlank() ? "manager-service" : serviceName.trim();
