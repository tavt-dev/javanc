package com.javanc.email.interfaces.rest.ratelimit;
...
public class RateLimitFilter implements ContainerRequestFilter {
    ...
    public RateLimitFilter(
            ...
            @ConfigProperty(name = "quarkus.application.name", defaultValue = "email-service") String serviceName,
        ...
        this.serviceName = value(serviceName).isBlank() ? "email-service" : serviceName.trim();
