...
public class OutboxPublisherWorker {
    ...
    public void poll() {
        ...
        for (OutboxEventEntity record : repository.findReady(Instant.now(), batchSize)) {
            publish(record);
        }
    }

    public void publish(OutboxEventEntity record) {
        try {
    ...
    private void markFailure(OutboxEventEntity record, Throwable failure) {
        record.attemptCount++;
    ...
    private void recordMetric(OutboxEventEntity record, String status) {
    ...
    private void publishMetric(OutboxEventEntity record, String outcome) {
