package com.javanc.user.adapter.in.rest.ratelimit;
...
public class RateLimitFilter implements ContainerRequestFilter {
    ...
    public RateLimitFilter(
            ...
            @ConfigProperty(name = "quarkus.application.name", defaultValue = "user-service") String serviceName,
        ...
        this.serviceName = value(serviceName).isBlank() ? "user-service" : serviceName.trim();
