package com.javanc.notification.interfaces.rest.ratelimit;
...
public class RateLimitFilter implements ContainerRequestFilter {
    ...
    public RateLimitFilter(
            ...
            @ConfigProperty(name = "quarkus.application.name", defaultValue = "notification-service") String serviceName,
        ...
        this.serviceName = value(serviceName).isBlank() ? "notification-service" : serviceName.trim();
