...
public enum ErrorCode {
    ...
    PROJECT_NOT_FOUND(3001, "Project not found", 404),
    PROJECT_ALREADY_EXISTS(3002, "Project already exists", 409),
    PROJECT_UNABLE_TO_SAVE(3003, "Unable to save project", 500),
    PROJECT_UNABLE_TO_UPDATE(3004, "Unable to update project", 500),
    PROJECT_UNABLE_TO_DELETE(3005, "Unable to delete project", 500);
