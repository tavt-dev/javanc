package com.javanc.profile.application.exception;
...
public enum ErrorCode {
    ...
    PROFILE_OWNER_CONFLICT(2006, "Profile already exists for this user", 409),
    IMAGE_UPLOAD_FAILED(2101, "Image upload failed", 502),
